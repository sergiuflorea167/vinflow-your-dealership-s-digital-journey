...
export const WORKSHOP_REGISTRY: Record<WorkshopKey, WorkshopDef> = {
  dashboard: {
    ...
    route: "/", labelPrefix: "Dashboard-Workshop", steps: DASHBOARD_WORKSHOP_STEPS,
  },
  fleet: {
    key: "fleet", icon: Warehouse, title: "Bestand-Workshop",
    desc: "Filter, Sortierung, Aufnahme und Import-Funktionen im Bestand.",
    route: "/bestand", labelPrefix: "Bestand-Workshop", steps: FLEET_WORKSHOP_STEPS,
  },
  processes: {
    ...
    route: "/vorgaenge", labelPrefix: "Vorgänge-Workshop", steps: PROCESSES_WORKSHOP_STEPS,
  },
  purchase: {
  ...
  settings: {
    ...
    route: "/konfiguration", labelPrefix: "Konfigurations-Workshop", steps: SETTINGS_WORKSHOP_STEPS,
  },
};
