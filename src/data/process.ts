...
export const MOCK_VEHICLES: Vehicle[] = [
  ...
  {
    id: "V-021", vin: "WBAJB91070BL77234", type: "limousine", make: "BMW", model: "M5 Competition", year: 2024, color: "Frozen Bluestone",
    mileage: 6200, fuel: "Benzin", transmission: "Automatik", power_kw: 460, power_hp: 625, doors: 4, seats: 5,
    firstRegistration: "2024-02-14", hu: "2027-02-14",
    listPrice: 142500, purchasePrice: 122000, status: "in_stock", arrivedAt: isoDaysAgo(11),
  ...
  {
    id: "V-022", vin: "WAUZZZF55LA112388", type: "suv", make: "Audi", model: "RS Q3 Sportback", year: 2024, color: "Kyalamigrün",
    mileage: 8400, fuel: "Benzin", transmission: "DKG", power_kw: 294, power_hp: 400, doors: 5, seats: 5,
    firstRegistration: "2024-04-22", hu: "2027-04-22",
    listPrice: 78400, purchasePrice: 65500, status: "in_stock", arrivedAt: isoDaysAgo(5),
    location: { name: "Showroom", kind: "showroom", since: isoDaysAgo(5) },
    locationHistory: [],
    costs: [],
  },
  {
    id: "V-023", vin: "1HGCM82633A123456", type: "limousine", make: "Honda", model: "Civic Type R", year: 2024, color: "Boost Blue",
    mileage: 4200, fuel: "Benzin", transmission: "Schaltgetriebe", power_kw: 245, power_hp: 329, doors: 5, seats: 4,
    firstRegistration: "2024-03-08", hu: "2027-03-08",
    listPrice: 51900, purchasePrice: 43500, status: "in_stock", arrivedAt: isoDaysAgo(7),
    location: { name: "Hof A · Platz 08", kind: "lot", since: isoDaysAgo(7) },
    locationHistory: [],
    costs: [],
  },
  {
    id: "V-024", vin: "JN1AZ4EH7CM334455", type: "limousine", make: "Nissan", model: "GT-R Premium", year: 2023, color: "Pearl White",
    mileage: 12800, fuel: "Benzin", transmission: "DKG", power_kw: 419, power_hp: 570, doors: 2, seats: 4,
    firstRegistration: "2023-08-30", hu: "2026-08-30",
    listPrice: 119900, purchasePrice: 102000, status: "in_stock", arrivedAt: isoDaysAgo(34),
    location: { name: "Showroom", kind: "showroom", since: isoDaysAgo(20) },
  ...
  {
    id: "V-026", vin: "ZHWUC1ZD7LLA22311", type: "limousine", make: "Lamborghini", model: "Huracán EVO", year: 2023, color: "Verde Mantis",
    mileage: 5400, fuel: "Benzin", transmission: "DKG", power_kw: 470, power_hp: 640, doors: 2, seats: 2,
    firstRegistration: "2023-05-12", hu: "2026-05-12",
    listPrice: 248000, purchasePrice: 215000, status: "in_stock", arrivedAt: isoDaysAgo(45),
  ...
  {
    id: "V-027", vin: "VF1FW18B543987122", type: "transporter", make: "Renault", model: "Master L3H2 dCi 165", year: 2023, color: "Grau Mineral",
    mileage: 38500, fuel: "Diesel", transmission: "Schaltgetriebe", power_kw: 121, power_hp: 165, doors: 5, seats: 3,
  ...
  {
    id: "V-028", vin: "WP1ZZZ92ZGLA45678", type: "suv", make: "Porsche", model: "Cayenne Coupé Turbo", year: 2024, color: "Carraraweiß",
    mileage: 9800, fuel: "Benzin", transmission: "Automatik", power_kw: 405, power_hp: 550, doors: 5, seats: 5,
    firstRegistration: "2024-01-22", hu: "2027-01-22",
    listPrice: 168900, purchasePrice: 145000, status: "sold", arrivedAt: isoDaysAgo(78),
  ...
  {
    id: "V-029", vin: "VF7N4HMZ8GL445566", type: "kombi", make: "Peugeot", model: "508 SW Hybrid GT", year: 2024, color: "Perle Nera",
    mileage: 14200, fuel: "Plug-in-Hybrid", transmission: "Automatik", power_kw: 165, power_hp: 225, doors: 5, seats: 5,
    firstRegistration: "2024-02-10", hu: "2027-02-10",
    listPrice: 38900, purchasePrice: 31500, status: "in_stock", arrivedAt: isoDaysAgo(19),
  ...
  {
    id: "V-030", vin: "KMHK481GBHU778899", type: "suv", make: "Hyundai", model: "Tucson N Line Hybrid", year: 2024, color: "Phantom Black",
    mileage: 11700, fuel: "Hybrid", transmission: "Automatik", power_kw: 169, power_hp: 230, doors: 5, seats: 5,
    firstRegistration: "2024-03-15", hu: "2027-03-15",
    listPrice: 34800, purchasePrice: 28200, status: "in_stock", arrivedAt: isoDaysAgo(16),
  ...
  },
  {
    ...
    listPrice: 32500, purchasePrice: 26900, status: "reserved", arrivedAt: isoDaysAgo(40),
  ...
  {
    id: "V-032", vin: "5UXTR9C50MLE99887", type: "suv", make: "BMW", model: "X3 M40d", year: 2024, color: "Carbonschwarz",
    mileage: 13400, fuel: "Diesel", transmission: "Automatik", power_kw: 250, power_hp: 340, doors: 5, seats: 5,
    firstRegistration: "2024-01-08", hu: "2027-01-08",
    listPrice: 68900, purchasePrice: 57500, status: "in_stock", arrivedAt: isoDaysAgo(26),
    location: { name: "Showroom", kind: "showroom", since: isoDaysAgo(15) },
  ...
  {
    id: "V-033", vin: "WV2ZZZ7HZNH883344", type: "transporter", make: "Volkswagen", model: "T6.1 Multivan Edition", year: 2023, color: "Mojavebeige",
    mileage: 35200, fuel: "Diesel", transmission: "DKG", power_kw: 146, power_hp: 199, doors: 5, seats: 7,
    firstRegistration: "2023-03-18", hu: "2026-03-18",
    listPrice: 56900, purchasePrice: 47800, status: "in_stock", arrivedAt: isoDaysAgo(52),
  ...
  {
    id: "V-034", vin: "JM3KFBDMXM0556677", type: "suv", make: "Mazda", model: "CX-60 PHEV Takumi", year: 2024, color: "Soul Red Crystal",
    mileage: 7800, fuel: "Plug-in-Hybrid", transmission: "Automatik", power_kw: 241, power_hp: 327, doors: 5, seats: 5,
    firstRegistration: "2024-04-12", hu: "2027-04-12",
    listPrice: 54900, purchasePrice: 45200, status: "in_stock", arrivedAt: isoDaysAgo(8),
    location: { name: "Hof A · Platz 15", kind: "lot", since: isoDaysAgo(8) },
    locationHistory: [],
    costs: [],
  },
  {
    id: "V-035", vin: "5YJYGDEE6MF114455", type: "suv", make: "Tesla", model: "Model Y Performance", year: 2024, color: "Solid Black",
    mileage: 9100, fuel: "Elektro", transmission: "Automatik", power_kw: 393, power_hp: 534, doors: 5, seats: 5,
    firstRegistration: "2024-02-28", hu: "2027-02-28",
    listPrice: 58400, purchasePrice: 49500, status: "sold", arrivedAt: isoDaysAgo(70),
  ...
  {
    id: "V-036", vin: "WDDXJ8KB3JA001234", type: "cabrio", make: "Mercedes-Benz", model: "AMG GT C Roadster", year: 2023, color: "Selenitgrau Magno",
    mileage: 6800, fuel: "Benzin", transmission: "DKG", power_kw: 410, power_hp: 557, doors: 2, seats: 2,
    firstRegistration: "2023-07-04", hu: "2026-07-04",
    listPrice: 168900, purchasePrice: 142000, status: "in_stock", arrivedAt: isoDaysAgo(38),
...
export const MOCK_OFFERS: Offer[] = [
  ...
  { id: "OFR-2025-0249", vehicleId: "V-021", customerId: "C-016", createdAt: isoDaysAgo(5), validUntil: "2025-06-04", price: 142500, status: "sent", customerTodos: [{ id: "t1", title: "Garantie-Verlängerung 12 Monate" }] },
  { id: "OFR-2025-0250", vehicleId: "V-022", customerId: "C-017", createdAt: isoDaysAgo(2), validUntil: "2025-06-08", price: 78400, status: "sent", customerTodos: [] },
  { id: "OFR-2025-0251", vehicleId: "V-024", customerId: "C-018", createdAt: isoDaysAgo(7), validUntil: "2025-05-30", price: 119900, status: "sent", customerTodos: [{ id: "t1", title: "Probefahrt am Wochenende" }] },
  { id: "OFR-2025-0252", vehicleId: "V-026", customerId: "C-019", createdAt: isoDaysAgo(15), validUntil: "2025-05-25", price: 248000, status: "sent", customerTodos: [{ id: "t1", title: "Finanzierungsangebot prüfen" }] },
  ...
  { id: "OFR-2025-0254", vehicleId: "V-028", customerId: "C-019", createdAt: isoDaysAgo(72), validUntil: "2025-03-30", price: 168900, status: "accepted", customerTodos: [] },
  { id: "OFR-2025-0255", vehicleId: "V-031", customerId: "C-020", createdAt: isoDaysAgo(8), validUntil: "2025-06-01", price: 32500, status: "accepted", customerTodos: [{ id: "t1", title: "Winterreifen mitnehmen" }] },
  { id: "OFR-2025-0256", vehicleId: "V-032", customerId: "C-021", createdAt: isoDaysAgo(4), validUntil: "2025-05-29", price: 68900, status: "sent", customerTodos: [] },
  { id: "OFR-2025-0257", vehicleId: "V-033", customerId: "C-022", createdAt: isoDaysAgo(11), validUntil: "2025-05-26", price: 56900, status: "draft", customerTodos: [] },
  { id: "OFR-2025-0258", vehicleId: "V-034", customerId: "C-023", createdAt: isoDaysAgo(3), validUntil: "2025-06-02", price: 54900, status: "sent", customerTodos: [{ id: "t1", title: "Testtag mit Familie" }] },
  { id: "OFR-2025-0259", vehicleId: "V-035", customerId: "C-024", createdAt: isoDaysAgo(60), validUntil: "2025-03-30", price: 58400, status: "accepted", customerTodos: [] },
  { id: "OFR-2025-0260", vehicleId: "V-036", customerId: "C-019", createdAt: isoDaysAgo(20), validUntil: "2025-05-15", price: 168900, status: "rejected", customerTodos: [] },
  { id: "OFR-2025-0261", vehicleId: "V-036", customerId: "C-025", createdAt: isoDaysAgo(8), validUntil: "2025-06-04", price: 169500, status: "sent", customerTodos: [{ id: "t1", title: "Ledersitze in Sonderfarbe" }] },
  ...
  { id: "OFR-2025-0263", vehicleId: "V-008", customerId: "C-020", createdAt: isoDaysAgo(6), validUntil: "2025-05-28", price: 68900, status: "sent", customerTodos: [{ id: "t1", title: "Wallbox 11kW als Zubehör" }] },
  { id: "OFR-2025-0264", vehicleId: "V-013", customerId: "C-016", createdAt: isoDaysAgo(9), validUntil: "2025-05-22", price: 21800, status: "rejected", customerTodos: [] },
  { id: "OFR-2025-0265", vehicleId: "V-019", customerId: "C-026", createdAt: isoDaysAgo(2), validUntil: "2025-06-08", price: 39800, status: "sent", customerTodos: [] },
  { id: "OFR-2025-0266", vehicleId: "V-029", customerId: "C-022", createdAt: isoDaysAgo(7), validUntil: "2025-05-26", price: 38900, status: "sent", customerTodos: [{ id: "t1", title: "Anhängerkupplung nachrüsten" }] },
  { id: "OFR-2025-0267", vehicleId: "V-030", customerId: "C-027", createdAt: isoDaysAgo(5), validUntil: "2025-05-30", price: 34800, status: "draft", customerTodos: [] },
];
